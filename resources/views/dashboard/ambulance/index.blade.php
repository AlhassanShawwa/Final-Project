...
@section('content')
    ...
    <!--begin::Modal -->
    @include('dashboard.ambulance.create')
    <!--end::Modal -->
        ...
        jQuery(document).ready(function() {
            ...
            table.DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'car_model',
                        title: "{{ __('datatable.car_model') }}"
                    },
                    {
                        data: 'car_number',
                        title: "{{ __('datatable.car_number') }}"
                    },
                    {
                        data: 'car_year_made',
                        title: "{{ __('datatable.car_year_made') }}"
                    },
            ...
            $(document).on('click', '#edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#car_year_made').val(data.car_year_made);
                        $('#kt_blockui_4_4').data('id', ambulanceid);
                        $('#kt_blockui_4_4_modal').modal('show');
                    }
                });
            });
            $(document).on('click', '#kt_blockui_4_4', function(e) {
                e.preventDefault();
                var ajaxRoute = '{!! route('ambulances.store') !!}';
                var ambulanceid = $(this).data('id');
                var ajaxData = $('.kt_form').serialize();
                var ajaxMethod = 'POST';
                if (ambulanceid) {
                    ajaxRoute = '{!! route('ambulances.update', ['ambulance' => '__id__']) !!}';
