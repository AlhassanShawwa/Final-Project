        ...
        jQuery(document).ready(function() {
            ...
            $('#kt_form_1').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        setTimeout(function() {
                            window.location.href = "{{ route('laps.index') }}";
                        }, 2000);
                        swal.fire({
                            position: 'top-right',
                            type: 'success',
                            title: '{{ __('alert.lap.updated') }}',
