    ...
    <div class="kt-header__topbar">
            ...
            <div
                ...
                <form>
                    ...
                    <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b"
                        style="background-image: url(adminassets/assets/media/misc/bg-1.jpg)">
                        ...
                        <div class="kt-mycart__body kt-scroll" data-scroll="true" data-height="245"
                            ...
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{ asset('adminassets/assets/media/products/product9.jpg') }}"
                                            title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{ asset('adminassets/assets/media/products/product13.jpg') }}"
                                            title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{ asset('adminassets/assets/media/products/product16.jpg') }}"
                                            title="">
                                    </a>
                                </div>
                            </div>
                            <div class="kt-mycart__item">
                                <div class="kt-mycart__container">
                                    ...
                                    <a href="#" class="kt-mycart__pic">
                                        <img src="{{ asset('adminassets/assets/media/products/product15.jpg') }}"
                                            title="" alt="">
                                    </a>
                                </div>
                            </div>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                <span class="kt-header__topbar-icon">
                    <img class=""
                        src="{{ asset('adminassets/assets/media/flags/' . app()->currentLocale() . '.jpg') }}"
                        alt="" />
                </span>
            </div>
            <div
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        <li
                            ...
                            <a rel="alternate"
                                ...
                                hreflang="{{ $localeCode }}" class="kt-nav__link">
                                <span class="kt-nav__link-icon"><img
                                        src="{{ asset('adminassets/assets/media/flags/' . $properties['flag']) }}"
                                        alt="" /></span>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    <span class="kt-header__topbar-welcome kt-hidden-mobile">{{ __('dashboard.hi') }}</span>
                    <span class="kt-header__topbar-username kt-hidden-mobile">{!! Auth::user()->trans_first_name !!}
                    </span>
                    @if (Auth::user()->image)
                        <img alt="Pic" src="{{ asset('uploads/admins/' . Auth::user()->image) }}" />
                    @else
                        <span
                            class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold">{{ mb_substr(Auth::user()->trans_first_name, 0, 1) }}
                        </span>
                    @endif
                </div>
            </div>
            <div
                ...
                <div class="kt-notification">
                    ...
                    <div class="kt-notification__custom kt-space-between">
                        <a href="javascript:;" target="_blank" class="btn btn-label btn-label-brand btn-sm btn-bold"
