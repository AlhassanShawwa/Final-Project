            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        &nbsp;
                        <a href="{{ route('drivers.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
        ...
        jQuery(document).ready(function() {
            ...
            table.DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'license_number',
                        title: "{{ __('datatable.license_number') }}"
                    },
                    {
                        data: 'car_number',
            ...
            $(document).on('click', '#updatestatus', function() {
                ...
                $.ajax({
                    url: '/dashboard/admin/drivers/' + driverId + '/get-status',
                    type: 'GET',
                    success: function(response) {
                        ...
                        $('#saveStatusChanges').data('id', driverId);
            ...
            $('#saveStatusChanges').on('click', function() {
                ...
                $.ajax({
                    url: '/dashboard/admin/drivers/' + driverId + '/update-status',
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        status: status,
